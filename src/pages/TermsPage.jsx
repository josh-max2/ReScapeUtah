  ...
  return (
    <>
      <SEO
        ...
        description="ReScapeUtah terms of service — the nature of our service, what is included, limitations, and your rights as a customer."
      />
      <div className="legal-page">
        <div className="container">
          ...
          <div className="legal-body">
            ...
            <p>ReScapeUtah provides digital planning and analysis services for Utah homeowners. Our service includes AI-powered yard concept images, CAD-style top-down plans, cost estimates, water-saving projections, and Utah Water Savers rebate guidance, delivered as downloadable PDF reports.</p>
            ...
            <h2>7. All Sales Final</h2>
            <p>All purchases are final. We do not offer refunds. If you have concerns about the quality or completeness of your report, contact us and we will work to address them. Our goal is to deliver a useful, accurate planning document — if something is missing or incorrect, we want to know. Contact us through the <Link to="/contact">contact page</Link>.</p>
            ...
            <p>To the maximum extent permitted by applicable law, ReScapeUtah and its owners shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of our service or reliance on our reports. Our total liability to you for any claim arising from your order shall not exceed the amount you paid for that order.</p>
