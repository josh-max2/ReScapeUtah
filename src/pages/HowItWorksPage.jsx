...
const STEPS = [
  {
    ...
    body: 'Fill out our short intake form. We need your street address, photos of your yard, approximate square footage, current grass situation, general goals, and Utah city. The form takes about 5 minutes.',
    delivers: 'Delivers: A clear project brief we use to tailor your analysis.',
  },
  {
    n: '2',
    title: 'We Build Your Analysis',
    body: 'Our team generates your AI-powered concept images across multiple design directions, produces your CAD-style top-down plan, and prepares your itemized cost estimate and rebate guidance. We review everything before delivery.',
  ...
  },
  {
    ...
    body: 'Use your plan to get accurate contractor quotes. Use your rebate guidance to understand your Utah Water Savers eligibility and prepare your application materials — submitted by you through utahwatersavers.com. Or simply use the knowledge to make a smarter decision about your project timeline.',
...
const HOW_IT_WORKS_SCHEMA = {
  ...
  '@type': 'HowTo',
  name: 'How ReScapeUtah Works',
  description: 'How to get a ReScapeUtah yard planning report, from intake to using your plan.',
  step: STEPS.map((s, i) => ({
    '@type': 'HowToStep',
    position: i + 1,
    name: s.title,
...
export default function HowItWorksPage() {
  return (
    <>
      <SEO
        title="How ReScapeUtah Works + Utah Water Savers Guide"
        description="Learn how ReScapeUtah works — from intake form to your complete report. Plus a plain-language guide to Utah Water Savers rebates, eligibility, and how to apply."
      ...
      <div className="page-hero">
        <div className="container--sm">
          ...
          <h1 className="page-hero-title">How ReScapeUtah works</h1>
        ...
        <div className="container--sm">
          ...
          <div className="hiw-rebate-grid">
            <div className="hiw-rebate-card">
              ...
              <p>
                Utah Water Savers is a state-promoted water conservation initiative where participating local water providers offer financial rebates to homeowners who replace water-intensive grass with water-efficient landscaping such as drip-irrigated plants, decomposed granite, or other low-water alternatives.
              </p>
              <p>
                The program is administered at the local level — your water provider, not the state directly, determines your eligibility, rate, and any program requirements specific to your area. Visit{' '}
            ...
            <div className="hiw-rebate-card">
              ...
              <div className="hiw-fact-list">
                <div className="hiw-fact">Some providers offer up to $3 per square foot for qualifying grass replacement (statewide maximum per general Utah Water Savers guidance).</div>
                <div className="hiw-fact">CUWCD cities typically range $1.50–$3.00/sq ft. WBWCD cities are around $2.50/sq ft.</div>
            ...
            <div className="hiw-rebate-card">
              ...
              <div className="hiw-fact-list">
                <div className="hiw-fact">Before-and-after photos of the grass area being replaced.</div>
                ...
                <div className="hiw-fact">Applications are submitted directly by the homeowner to their water provider through utahwatersavers.com.</div>
              </div>
            </div>
        ...
        <div className="container--sm">
          ...
          <div style={{ display: 'grid', gap: 20 }}>
            {[
              ...
              { icon: '🎯', title: 'Choose the right design', body: 'Reviewing AI-powered concepts lets you develop a clear visual preference before spending money with a landscaper. You walk into quotes knowing what you want.' },
